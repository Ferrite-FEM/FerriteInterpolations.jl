...
@testset "TNTDiv" begin
    ip = TNTDiv{RefQuadrilateral, 1}()

    # (i) Interpolation-level tests
    test_interpolation_properties(ip)
    test_type_genericity(ip)

    # Live symfem cross-check ("TNTdiv"): signed permutation derived with
    ...
    test_symfem_reference_vector(
        ip, "TNTdiv", 1,
        [(-1 // 2, 0), (-1 // 2, 1), (-1 // 2, 4), (-1 // 2, 5), (1 // 2, 7), (1 // 2, 6), (1 // 2, 3), (1 // 2, 2), (1 // 2, 8), (1 // 2, 9), (1 // 2, 10)],
    )
